...
function BookDetails() {
  ...
  if (!book) {
    return (
      <section className="px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <EmptyState title="Book not found" message="The selected book is not available in the trained model." />
        </div>
      </section>
    );
  }
  ...
  return (
    <section className="px-4 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="glass-card grid gap-8 rounded-[2rem] p-5 sm:p-8 lg:grid-cols-[360px_1fr]">
          <div className="overflow-hidden rounded-3xl bg-slate-900">
            {imageUrl ? (
              <img src={imageUrl} alt={book.title} className="h-[32rem] w-full object-cover object-top" />
            ) : (
              <div className="grid h-[32rem] place-items-center text-slate-400">Cover unavailable</div>
            )}
          </div>

          <div className="flex flex-col justify-center">
            <p className="mb-3 text-sm font-bold uppercase tracking-[0.25em] text-cyan-300">Book details</p>
            <h1 className="text-4xl font-black tracking-tight text-white sm:text-5xl">{book.title}</h1>
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-3xl bg-white/5 p-5">
                <div className="mb-2 flex items-center gap-2 text-cyan-300">
                  <Users size={18} /> Number of Ratings
                </div>
        ...
        <div className="mt-14">
          <SectionHeader
            ...
            description="These are generated by the same cosine-similarity model used on the recommendation page."
          />
